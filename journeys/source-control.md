...
* Steps 1 to 4 are **mandatory** for all projects  
* Steps 5 to 9 are *optional*, but it is recommended that teams implement them as soon as practically possible.  
...
Git is the required source control management system at SAGE and where possible teams should look to upgrade from other systems such as SVN, Mercurial or CVS. 
...
If you are using Github, code must be managed under the [SAGE Publishing](https://github.com/sagepublishing) organization.
...
Implement an .ignore file at the project’s root to stop these files being committed to source control. 
...
Make sure you implement a line in your .gitignore file (step 3) to stop the packages being committed to source control. The source control’s configuration file should of course be included. 
